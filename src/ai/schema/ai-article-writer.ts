...
export const AiArticleWriterInputSchema = z.object({
...
export type AiArticleWriterInput = z.infer<typeof AiArticleWriterInputSchema>;

export const AiArticleWriterOutputSchema = z.object({
...
export type AiArticleWriterOutput = z.infer<typeof AiArticleWriterOutputSchema>;
