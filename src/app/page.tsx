...
const faqItems = [
    {
        question: "What is TotaPakhi AI?",
        answer: "TotaPakhi AI is an advanced AI content generation platform designed to help content creators, marketers, and businesses create high-quality, SEO-optimized content in over 150 languages, with a special focus on Bengali."
    },
    {
    ...
    {
        question: "What types of content can TotaPakhi AI create?",
        answer: "TotaPakhi AI can create a wide variety of content, including blog posts, news articles, product descriptions, social media captions, professional emails, and much more. It can also generate stunning AI images."
    },
    {
        question: "Is the generated content original and plagiarism-free?",
        answer: "Yes, all content generated by TotaPakhi AI is 100% original and passes plagiarism checks. Our AI is designed to create unique content from scratch based on the prompts and data it analyzes."
    },
     {
        question: "How do I publish content to my website?",
        answer: "We offer seamless integration with WordPress, allowing you to publish your generated articles directly to your website with just a single click from your TotaPakhi AI dashboard."
    },
    {
    ...
    {
        question: "What image generation capabilities does TotaPakhi AI offer?",
        ...
        <section className="py-16 md:py-24">
            <div className="container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto">
                    ...
                    <p className="text-lg text-muted-foreground mt-4">
                        Everything you need to know about TotaPakhi AI and our content generation tools.
                    </p>
                </div>
