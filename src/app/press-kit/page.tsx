                    ...
                    <div className="lg:col-span-2 space-y-12">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4 text-muted-foreground">
                                ...
                                <p>
                                    Our platform leverages state-of-the-art AI 2.0 technology to automate and accelerate the content creation process, offering tools for one-click article generation, bulk content creation, video-to-blog conversion, and much more. Founded by Mojibur Rahman, TotthoAi is headquartered in Cox's Bazar, Bangladesh, with a mission to foster a vibrant digital ecosystem.
                                </p>
                            </CardContent>
                        </Card>
