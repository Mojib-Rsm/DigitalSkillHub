...
import { getSerpAnalysisAction, generateArticleFromSerpAction } from "@/app/ai-tools/ai-article-writer/actions";
...
import { AiArticleWriterInput, type AiArticleWriterOutput } from "@/ai/schema/ai-article-writer";
...
export default function AiArticleWriterForm() {
  ...
  const [data, setData] = useState<AiArticleWriterOutput | undefined>(undefined);
  const [serpResults, setSerpResults] = useState<SerpResult[]>([]);
  const [currentInput, setCurrentInput] = useState<AiArticleWriterInput | null>(null);
